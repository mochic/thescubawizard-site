...
export default () => {
  ...
  const { textOpacity, arrowOpacity } = useSpring({
    from: { textOpacity: 0, arrowOpacity: 0 },
    to: [{ textOpacity: revealed ? 1 : 0 }, { arrowOpacity: revealed ? 1 : 0 }],
  })
      ...
      <MainTainr>
        <ContentTainr>
          ...
          <FancyLink
            ...
            arrowProps={{ opacity: arrowOpacity }}
          >
            Get started today!
          </FancyLink>
        </ContentTainr>
