...
import Image from "../components/ContactImage7"
...
const NavTainr2 = styled(animated.div)`
  position: absolute;
  z-index: 1000;
  width: 100%;
  text-align: center;
...
const OtherNavBar2 = ({ handleClick, svgProps, ...rest }) => {
  ...
  return (
    <NavTainr2 {...rest}>
      <TitleSVG onClick={_handleClick} {...svgProps} />
    </NavTainr2>
  )
}
...
export default () => {
  ...
  const homeLinkProps = useSpring({
    ...
    from: { svgOpacity: 0, svgBlurRadius: 20 },
